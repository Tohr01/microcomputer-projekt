...
ghdl -a -fsynopsys --workdir=$WORK_DIR opcodes_constants.vhd memPkg.vhd statesPkg.vhd alu.vhd registerbank.vhd ramIO.vhd control-unit_2try.vhd control-unit_2try_testbench.vhd
